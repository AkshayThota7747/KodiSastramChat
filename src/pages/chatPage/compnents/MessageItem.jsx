...
import { PhotoMessage, FileMessage, SystemMessage, LocationMessage, SpotifyMessage, ReplyMessage, MeetingMessage, VideoMessage, AudioMessage, MeetingLink, Avatar }from "react-chat-elements"
...
const MessageItem = ({ focus = false, notch = true, styles, ...props }) => {
  ...
  return (
    <div ref={messageRef} className={classNames('rce-container-mbox', props.className)} onClick={props.onClick} style={{
        display: 'flex',
        flexDirection: 'row'
    }}>
